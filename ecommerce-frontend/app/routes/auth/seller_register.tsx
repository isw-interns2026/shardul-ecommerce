...
import type { Route } from "./+types/seller_register";
import { sendSellerRegisterRequest } from "~/services/AuthService";
...
export async function clientAction({ request }: Route.ActionArgs) {
  ...
  try {
    await sendSellerRegisterRequest(formData);
    ...
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-slate-50 p-4 py-12">
      ...
      <Card className="w-full max-w-md border-2 shadow-xl">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>
            Create a seller account to start listing products
          </CardDescription>
        </CardHeader>
      ...
      <p className="mt-8 text-center text-xs text-muted-foreground max-w-xs leading-relaxed">
        By registering, you agree to our Seller Terms of Service and commit to
