...
import type { Route } from "./+types/seller_login";
import { sendSellerLoginRequest } from "~/services/AuthService";
...
export async function clientAction({ request }: Route.ActionArgs) {
  ...
  try {
    await sendSellerLoginRequest(formData);
...
export default function SellerLoginPage({ actionData }: Route.ComponentProps) {
